                    ...
                    if value_idx >= 0:
                        ...
                        for i in range(calc_tab.calibration_table.rowCount()):
                            ...
                            budget.append({
                                ...
                                'distribution': (
                                    self.tr(get_distribution_translation_key(calc_tab.value_handler.get_distribution(variable_name)))
                                    if get_distribution_translation_key(calc_tab.value_handler.get_distribution(variable_name))
                                    else calc_tab.value_handler.get_distribution(variable_name)
                                ) or '-',
