...
translations = {'CorrelationTab': {'MESSAGE_WARNING': '警告',
 ...
 'MainWindow': {'APP_TITLE': '校正の不確かさ計算ツール',
                ...
                'FILE_EXIT': '終了',
                'FILE_NEW': '新規作成',
                'NEW_FILE_CONFIRM_TITLE': '新規作成',
                'NEW_FILE_CONFIRM_TEXT': '現在開いているファイルを閉じて新規作成しますか？\nYES: 既存の入力をすべて消去\nNO: 中断',
                'SETTINGS_ACTION_TEXT': '設定...',
                'BULK_INPUT_ACTION_TEXT': '一括入力モード...',
                'UNIT_VALIDATION_TAB_TEXT': '単位整合検証',
                'TAB_EQUATION': 'モデル式',
 ...
 'BulkInputDialog': {'BULK_INPUT_DIALOG_TITLE': '一括入力モード',
                     'BULK_INPUT_MODE_HINT': 'タイプBと固定値のみ表示します。タイプAと計算結果は表示しません。',
                     'BULK_INPUT_APPLY': '反映',
                     'BULK_INPUT_CANCEL': 'キャンセル',
                     'BULK_INPUT_ROW_CENTRAL_VALUE': '中央値',
                     'BULK_INPUT_ROW_HALF_WIDTH': '半値幅',
                     'BULK_INPUT_ROW_DISTRIBUTION': '分布',
                     'BULK_INPUT_FIXED_VALUE_ROW': '固定値',
                     'BULK_INPUT_INVALID_NUMBER_TITLE': '入力エラー',
                     'BULK_INPUT_INVALID_NUMBER': '{row_label} / {point_name} の数値が不正です: {value}'},
 ...
 'VariablesTab': {'LABEL_UNIT': '単位',
                  ...
                  'TYPE_B': 'タイプB',
                  'FIXED_VALUE': '固定値',
                  'TYPE_A_INPUT_MODE': '入力モード',
                  'TYPE_A_INPUT_MODE_CSV': 'CSV',
                  'TYPE_A_INPUT_MODE_TABLE': '表',
                  'TYPE_A_ADD_MEASUREMENT': '行を追加',
                  'TYPE_A_REMOVE_MEASUREMENT': '行を削除',
