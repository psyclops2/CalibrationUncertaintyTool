...
translations = {
    ...
    "VariablesTab": {
        ...
        REGRESSION_X_MODE: "x mode",
        REGRESSION_X_MODE_POINT_NAME: "Use calibration point name as numeric value",
        REGRESSION_X_MODE_FIXED: "Specify fixed value",
    ...
    "RegressionTab": {
        ...
        REGRESSION_U_INTERCEPT: "u(x) intercept αu",
        REGRESSION_U_SLOPE: "u(x) slope βu",
        REGRESSION_U_SIGNIFICANCE_F: "u(x) Significance F",
    ...
    "ReportTab": {
        ...
        REPORT_REGRESSION_MODELS: "Regression Models",
        REPORT_REGRESSION_DATA_COUNT: "Data Points",
        REPORT_REGRESSION_SLOPE: "Slope",
        REPORT_REGRESSION_INTERCEPT: "Intercept",
        REPORT_REGRESSION_DOF: "Degrees of Freedom",
        REPORT_REGRESSION_RESIDUAL_STD: "Residual Std Dev",
